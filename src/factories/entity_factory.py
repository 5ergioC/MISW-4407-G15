...
def create_astronaut(world, spawn_x: float | None = None) -> int:
    ...
    world.add_component(
        ...
        Renderable(
            ...
            centered=True,
            sprite_frame_width=astronaut_frame_w,
        ),
    )
    world.add_component(entity, Collider(render_size, pygame.Vector2()))
...
# ── P4: Explosion factory ───────────────────────────────────────────────────

_EXPLOSION_COLORS: dict[str, tuple[tuple[int, int, int], tuple[int, int, int]]] = {
    "lander":  ((255, 255, 255), ( 56, 135,   0)),  # #388700
    "mutant":  ((255, 255, 255), ( 21,  95, 217)),  # #155fd9
    "baiter":  ((255, 255, 255), ( 38,  91, 110)),  # #265b6e
    "bomber":  ((255, 255, 255), (255,  96,  47)),  # #ff602f
    "pod":     ((255, 255, 255), (255, 187,   0)),  # #ffbb00
    "swarmer": ((255, 255, 255), (171,  68, 214)),  # #ab44d6
    "player":  ((255, 255, 255), (255, 105,  15)),
    "generic": ((255, 255, 255), (199,  55,   0)),
}
...
def create_explosion(
    ...
    for i in range(count):
        ...
        world.add_component(entity, Particle(kind=kind, start_color=start_color, end_color=end, lifetime_max=lt))
        world.add_component(entity, Lifetime(lt))
        entities.append(entity)
    return entities
