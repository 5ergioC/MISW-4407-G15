    ...
    def update(self, world, dt: float) -> None:
        ...
        for enemy_entity, (enemy_transform, enemy_velocity, enemy, enemy_state, enemy_tag) in world.get_components(
            ...
            if enemy_state.name == "transform_to_mutant":
                # perform immediate conversion: create mutant at lander position,
                # ensure astronaut disappears and mutant inherits horizontal speed
                ...
                try:
                    ...
                    if world.has_component(mutant_ent, Velocity):
                        ...
                        # inherit horizontal velocity from lander and give a downward Y
            ...
            if astronaut.state == "captured":
                ...
                # If the lander has reached the top while carrying an astronaut,
                # immediately convert to mutant: create mutant, remove both lander and astronaut.
